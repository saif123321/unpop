  ...
  const faqItems = [
    {
      ...
      answer: "big soda uses artificial everything. functional foods use questionnaire science. we use real ingredients to make something that tastes like what you wanted all along."
    },
    {
      question: "what's in it?",
      answer: "natural fruit sweetener, real cola flavor, carbonated water, and ingredients you can actually pronounce. full list in the section above."
    },
    {
      question: "does it taste exactly like coke?",
      answer: "no. it tastes like what cola would be if it started with real ingredients instead of 40 artificial ones. the flavor is recognizably cola, but cleaner, less chemical finish, more natural sweetness. most people prefer it. some need a can or two to adjust."
    },
    {
      question: "i'm used to diet soda, will i like this?",
      answer: "if you love aspartame zero calories, unpop isn't that. if you tolerate diet colas because regular soda makes you crash, try unpop. it tastes more like traditional cola than diet sodas, while making you crash less."
    },
    {
      question: "does it have caffeine?",
      answer: "it does. roughly the same amount you'd find in regular cola. plan accordingly if you're watching your caffeine intake."
    },
    {
      question: "is it good for me?",
      answer: "it's better than what you're drinking now. also, we use dates specifically because they don't spike blood sugar or cause sugar cravings."
    },
    {
      question: "will this make me bloated?",
      answer: "unlikely. we use natural fruit sweetener instead of loading it with prebiotics or fiber that can upset your stomach. just carbonated cola made with real ingredients."
    },
    {
      question: "sugar crash?",
      answer: "not with natural fruit sweetener. your blood sugar stays steady. your afternoon stays productive."
    },
    {
      question: "shipping speed?",
      answer: "we ship within 24 hours and you'll have it within 3 business days. could be faster. rarely slower."
    },
    {
      question: "subscription flexibility?",
      answer: "pause, skip, change frequency, or cancel anytime. we built it to be easy because we're not trying to trap you."
    }
  ];

  return (
    <div className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#500730' }}>

      {/* Header */}
      <header className="relative z-50 flex items-center justify-between px-6 md:px-16 py-4 md:py-6 text-sm md:text-xs tracking-widest font-aloevera uppercase" style={{ color: '#FF1275' }}>
        {/* Left – OUR STORY */}
        <a
          href="#our-story"
      ...
      {/* Sugar Facts Section */}
      <section className="relative py-20 flex items-center overflow-visible px-16 lg:px-32" style={{ backgroundColor: '#500730' }}>
        <div className="relative max-w-xl">
          <div className="text-left">
            ...
            >
              13g of sugar<br />from dates.
            </h2>

            {/* Benefits Text */}
            <div className="space-y-2 mb-8 font-aloevera tracking-widest text-xs md:text-sm" style={{ color: '#FF1275' }}>
      ...
      <section className="relative py-20 flex items-center overflow-visible px-16 lg:px-32" style={{ backgroundColor: '#500730' }}>
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-16 w-full items-center ">
          ...
          <div className="text-left">
            ...
            >
              a new<br />perspective<br />on taste
            </h2>

            {/* Story Text */}
            <div className="space-y-3 font-aloevera tracking-widest text-xs md:text-sm" style={{ color: '#FF1275' }}>
      ...
      <section className="relative w-full py-0 overflow-hidden" style={{ backgroundColor: '#500730' }}>
        {/* Top Pattern */}
        <div className="w-full h-20 flex items-center" style={{
          backgroundImage: 'repeating-linear-gradient(90deg, #FF1275 0px, #FF1275 2px, transparent 2px, transparent 12px)',
          opacity: 0.3
        }}></div>
      ...
      <section className="relative w-full pt-32 pb-32 overflow-hidden" style={{ backgroundColor: '#500730' }}>
        <div className="relative max-w-7xl mx-auto px-8 lg:px-16 h-full min-h-96 flex items-center justify-between">
          ...
          <div className="text-center flex-1 z-10">
            ...
            >
              13g<br />sugar<br />
              <span style={{ fontSize: '80px', fontStyle: 'italic' }}>from dates</span>
            </h2>
          </div>
      ...
      <section className="relative w-full py-32 pb-0 overflow-visible" style={{ backgroundColor: '#500730' }}>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <p
                  ...
                  className="font-aloevera"
                >
                  VANILLA BEAN,<br />CINNAMON, NUTMEG –<br />FLAVOR WITH SOUL.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <p
                  ...
                  className="font-aloevera"
                >
                  NATURAL SWEETNESS<br />WITH CARAMEL DEPTH.<br />AND SMOOTH LANDING.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <p
                  ...
                  className="font-aloevera"
                >
                  THE KIND THAT<br />SOUNDS RIGHT WHEN<br />YOU OPEN IT.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative w-full py-32 overflow-hidden" style={{ backgroundColor: '#350622' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 lg:col-span-4">
              <div className="grid grid-cols-4 gap-8 mb-8">
                <div></div>
                <div style={{ color: '#FF1275', fontSize: '18px', fontStyle: 'italic', letterSpacing: '0.05em' }} className="font-nineties">
                  BIG SODA
                </div>
                <div style={{ color: '#FF1275', fontSize: '18px', fontStyle: 'italic', letterSpacing: '0.05em' }} className="font-nineties">
                  GUT SODA
            ...
            {/* Sweetener Row */}
            <div style={{ color: '#FF1275', fontSize: '16px', fontStyle: 'italic', fontWeight: '100', letterSpacing: '0.05em' }} className="font-nineties">
              Sweetener
            </div>
            <div style={{ color: '#FF1275', fontSize: '13px', fontWeight: '400', letterSpacing: '0.08em', lineHeight: '1.6' }} className="font-aloevera">
      ...
      <section className="relative w-full py-32 overflow-visible" style={{ backgroundColor: '#500730' }}>
        <div className="relative max-w-7xl mx-auto px-8 lg:px-16">
      ...
      <section className="relative w-full py-0 overflow-hidden" style={{ backgroundColor: '#500730' }}>
        ...
        <div className="absolute bottom-0 right-24 pointer-events-none z-10 flex items-end" style={{ width: '30%', zIndex: 11111111 }}>
          <img
        ...
        {/* Bottom Pattern */}
        <div className="w-full h-20 flex items-center relative z-20" style={{
          backgroundImage: 'repeating-linear-gradient(90deg, #FF1275 0px, #FF1275 2px, transparent 2px, transparent 12px)',
          opacity: 0.3
        }}></div>
      </section>
      ...
      <section className="relative w-full py-0 overflow-visible" style={{ backgroundColor: '#500730' }}>
        {/* Main Content */}
        <div className="relative w-full flex flex-col items-center justify-start pt-20 pb-20">
          {/* Text Content - Centered with Tilt */}
          <div className="z-20 text-center max-w-4xl px-8 mb-20" style={{ transform: 'skewY(-2deg)' }}>
            <p
      ...
      <section className="relative w-full py-0 overflow-hidden" style={{ backgroundColor: '#500730' }}>
          ...
          <div className="max-w-6xl mx-auto px-8 lg:px-16 w-full">
            ...
            <div className="space-y-0">
              {faqItems.map((item, index) => (
                <div key={index} className="border-b" style={{ borderColor: '#FF1275' }}>
                  {/* Question Button */}
                  <button
        ...
        {/* Bottom Pattern */}
        <div className="w-full h-20 flex items-center mt-24" style={{
          backgroundImage: 'repeating-linear-gradient(90deg, #FF1275 0px, #FF1275 2px, transparent 2px, transparent 12px)',
          opacity: 0.3
        }}></div>
      </section>
      ...
      {/* Footer Section */}
      <footer className="relative w-full py-0 overflow-hidden" style={{ backgroundColor: '#350622' }}>
        {/* Logo at Top */}
              ...
              <div className="flex gap-4">
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="2" y="2" width="20" height="20" rx="5" stroke="#FF1275" strokeWidth="2" />
        ...
        <div className="w-full px-8 lg:px-16 py-6 border-t" style={{ borderColor: '#FF1275' }}>
